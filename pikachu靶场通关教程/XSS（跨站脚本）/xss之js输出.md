...
当在编辑框中输入`Hello`时网页的JS代码如下显示，输入的值被包含在变量`ms`中
...
![image-20230304134937222](C:\Users\linyunong\Desktop\Note\pikachu靶场通关教程\XSS（跨站脚本）\images\image-20230304134937222.png)
