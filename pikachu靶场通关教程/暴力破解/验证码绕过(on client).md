...
可以看到该关卡使用前端js进行验证码的验证

***

# 二、使用burp suite进行爆破

使用浏览器将JS禁用掉之后就不用输入验证码了，再去使用Burpsuite爆破即可

![image-20230303140916296](C:\Users\linyunong\Desktop\Note\pikachu靶场通关教程\暴力破解\images\image-20230303140916296.png)

爆破结果如下

![image-20230303141052051](C:\Users\linyunong\Desktop\Note\pikachu靶场通关教程\暴力破解\images\image-20230303141052051.png)
