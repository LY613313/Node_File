...
通过观察源码可以得到该关卡的代码在客户端对上传的文件进行检查，仅允许上传图片文件

***

# 二、通关教程

直接浏览器禁用前端js然后直接上传PHP一句话木马即可

![image-20230308141616539](C:\Users\linyunong\Desktop\Note\pikachu靶场通关教程\Unsafe file upload\images\image-20230308141616539.png)

![image-20230308141653044](C:\Users\linyunong\Desktop\Note\pikachu靶场通关教程\Unsafe file upload\images\image-20230308141653044.png)